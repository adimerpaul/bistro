<template>
  <q-page class="q-pa-xs">
    ...
    <div class="row q-col-gutter-sm items-end q-mb-sm">
      ...
      <div class="col-12 col-sm-3">
        <q-select dense outlined clearable v-model="estado" :options="estados" label="Estado"
          ...
          <q-btn-dropdown color="primary" label="Opciones" dropdown-icon="more_vert" no-caps dense size="10px">
            <q-list>
              ...
              <q-item clickable v-close-popup>
                <q-item-section>
                  <q-btn type="a" color="primary" no-caps dense class="full-width" icon="print"
                    label="Imprimir Formulario" :href="`${$api.defaults.baseURL}anulaciones/${props.row.id}/pdf`"
                    target="_blank" />
                </q-item-section>
              </q-item>
            </q-list>
