  ...
  <q-layout view="lHh Lpr lFf">
    ...
    >
      <q-list bordered class="rounded-borders">
        ...
        <q-expansion-item dense exact expand-separator icon="o_block" label="Anulaciones" to="/anulaciones" expand-icon="null" v-if="store.boolautorizar || store.boolaprobar"/>
